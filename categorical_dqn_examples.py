...
from networks.network_models import MLPCategoricalQNet
...
def run_categorical_dqn():
    ...
    config_file = 'config_files/' + args.env + '_categorical_dqn_feature.json'
    ...
    # model
    q_net = MLPCategoricalQNet(state_shape=config['state_shape'],
